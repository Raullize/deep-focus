  ...
  useEffect(() => {
    ...
    import('ogl').then(({ Renderer, Camera, Geometry, Program, Mesh }) => {
      ...
      try {
        ...
        // Set canvas style to ensure it stays within bounds
        gl.canvas.style.position = 'absolute';
        gl.canvas.style.top = '0';
        gl.canvas.style.left = '0';
        gl.canvas.style.width = '100%';
        gl.canvas.style.height = '100%';
        gl.canvas.style.pointerEvents = 'none'; // This allows clicks to pass through
        ...
        const resize = () => {
          // Get viewport dimensions (not container dimensions)
        ...
        // Provide a fallback or silent fail
        return () => {};
      }
    }).catch(err => {
